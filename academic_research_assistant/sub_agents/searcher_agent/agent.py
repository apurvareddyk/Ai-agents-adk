...
options.add_argument(f"--user-data-dir={tempfile.mkdtemp(prefix='chrome-user-')}")
options.add_argument(f"--disk-cache-dir={tempfile.mkdtemp(prefix='chrome-cache-')}")
options.add_argument(f"--data-path={tempfile.mkdtemp(prefix='chrome-data-')}")
